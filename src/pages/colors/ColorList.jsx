...
export default function ColorList() {
  ...
  const toggle = async (color) => { try { await updateColor(color.id, { ...color, isActive: !color.isActive }); load() } catch (requestError) { setError(requestError.response?.data?.message || 'Unable to update color status.') } }
