...
import { CircleDollarSign, Clock3, Eye, FileText, Settings2 } from 'lucide-react'
...
export default function EcommerceOrderList() {
  ...
  const visibleOrders = useMemo(() => orders.filter((order) => {
    ...
    return matchesStatus && matchesWarehouse && matchesCustomer && matchesDate
  }), [orders, status, warehouseId, customerId, dateFrom, dateTo])
